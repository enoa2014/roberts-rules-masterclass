...
const coreLinks = navLinksCore.map(({ label, href }) => ({
  label,
  href,
  icon: coreIconMap[href] ?? BookOpen,
}));

const links = coreLinks.filter(({ href }) => href === "/course" || href === "/about" || href === "/faq");

const learnerLinks = [
  ...coreLinks.filter(({ href }) =>
    href === "/course" ||
    href === "/rules" ||
    href === "/reading" ||
    href === "/tools" ||
        ...
        <div className={`nav-glass rounded-2xl transition-all duration-500 ${scrolled ? "shadow-political" : "shadow-lg"
          ...
          <div className="flex h-16 items-center justify-between px-6">
            ...
            <div className="hidden lg:flex items-center gap-4">
              {/* 主题选择器 */}
              <ThemeSelector placement="down" onThemeChange={(theme) => {
                // 仅当主题发生变化并触发回调后真正刷新 RSC 状态
                router.refresh();
              }} />
            ...
            <div className="glass-card p-6 animate-fadeInUp max-h-[calc(100vh-8rem)] overflow-y-auto overscroll-contain touch-pan-y">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <ThemeSelector placement="up" onThemeChange={(theme) => {
                    router.refresh();
                  }} />
                </div>
              </div>
