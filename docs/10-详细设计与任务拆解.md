...
| P0-03 | 实现注册登录 + proxy（原 middleware）+ /invite 流程（API + 最小可用页面壳） | Codex | P0-02 | auth API + 页面最小壳 | registered 可到 invite（Gemini 在 FE-B1 替换完整 UI） |
